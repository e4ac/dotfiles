...
if (Get-Command 'oh-my-posh' -ErrorAction Ignore && Test-Path "$HOME/.omp/themes/e4ac.omp.json") {
    oh-my-posh init pwsh --config "$HOME/.omp/themes/e4ac.omp.json" | Invoke-Expression
}
